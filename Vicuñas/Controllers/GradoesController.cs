...
namespace Vicuñas.Controllers
{
    public class GradoesController : Controller
    {
        ...
        public GradoesController(ContextoV context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,Nombre")] Grado grado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,Nombre")] Grado grado)
        {
            if (id != grado.Id)
            {
                return NotFound();
