...
namespace Vicuñas.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(ContextoV context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CI,Apellido_P,Apellido_M,Nombres,Rol,Sueldo")] Usuario usuario)
        {
            if (id != usuario.CI)
            {
                return NotFound();
